...
namespace Web.Controllers
{
    ...
    {
        private readonly VendorService _service = new VendorService();
        ...
        public ActionResult Create([Bind(Include = "VendorName,Email,Address,ContactNo")] Vendor item)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "VendorId,VendorName,Email,ContactNo,Address")] Vendor item)
        {
            if (ModelState.IsValid)
            {
                item.UpdatedDate = UserDateTime.GetUserDate();
        ...
        [HttpGet]
        [AllowAnonymous]
        public JsonResult GetVendorListJsonResult()
        {

            var items = _service.GetAll("").OrderBy(o=> o.VendorName);
