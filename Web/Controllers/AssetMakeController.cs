...
{
    public class AssetMakeController : Controller
    {
        private readonly AssetMakeService _service = new AssetMakeService();
        ...
        public ActionResult Create(AssetMake item)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit(AssetMake item)
        {
            if (ModelState.IsValid)
            {
                item.UpdatedDate = UserDateTime.GetUserDate();
        ...
        [HttpGet]
        [AllowAnonymous]
        public JsonResult GetAssetMakeListJsonResult()
        {
