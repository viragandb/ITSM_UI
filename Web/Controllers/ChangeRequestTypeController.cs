...
{
    public class ChangeRequestTypeController : Controller
    {
        private readonly ChangeRequestTypeService _service = new ChangeRequestTypeService();
        ...
        public ActionResult Create([Bind(Include = "ChangeRequestTypeName,Icon,Color,IsKPIApplicable")] ChangeRequestType item)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ChangeRequestTypeId,ChangeRequestTypeName,Icon,Color,IsKPIApplicable")] ChangeRequestType item)
        {
            if (ModelState.IsValid)
            {
                item.UpdatedDate = UserDateTime.GetUserDate();
        ...
        [HttpGet]
        [AllowAnonymous]
        public JsonResult GetChangeRequestTypeListJsonResult()
        {

            var items = _service.GetAll("").OrderBy(o=> o.ChangeRequestTypeName);
