...
{
    public class UserAccessItemTypeController : Controller
    {
        private readonly UserAccessItemTypeService _service = new UserAccessItemTypeService();
        ...
        public ActionResult Create(UserAccessItemType item)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit(UserAccessItemType item)
        {
            if (ModelState.IsValid)
            {
                if (item.Name == "" || item.Name == null)
