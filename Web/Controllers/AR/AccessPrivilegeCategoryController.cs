...
{
    public class AccessPrivilegeCategoryController : Controller
    {
        private readonly AccessPrivilegeCategoryService _service = new AccessPrivilegeCategoryService();
        ...
        public ActionResult Create(AccessPrivilegeCategory item)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit(AccessPrivilegeCategory item)
        {
            if (ModelState.IsValid)
            {
                item.UpdatedDate = UserDateTime.GetUserDate();
